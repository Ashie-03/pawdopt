...
const Hero = () => {
  return (
    <div className='flex flex-col w-full mt-6 mb-12 max-h-screen'>
      ...
      <h3 className='font-inter font-thin text-secondary text-center mt-2 relative z-10 animate-text-focus-in'>Bring joy into your life and theirs.<br></br>Adopt a furry friend today!</h3>
      <picture className="md:h-60 h-48 mt-4">
